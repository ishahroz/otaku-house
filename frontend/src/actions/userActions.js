...
export const login = (email, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${DJANGO_PROD_API_ALB_URL}/api/users/login/`,
...
export const register = (name, email, password) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${DJANGO_PROD_API_ALB_URL}/api/users/register/`,
...
export const getUserDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${DJANGO_PROD_API_ALB_URL}/api/users/${id}/`, config);
...
export const updateUserProfile = (user) => async (dispatch, getState) => {
  try {
    ...
    // USING ${id} BECAUSE WHILE ACCESSING NORMAL USER WE'LL PASS STRING 'profile' BUT WHILE ACCESSING ADMIN PANEL WE'LL PASS THE 'id' SO LINK HAS TO BE DYNAMIC
    const { data } = await axios.put(`${DJANGO_PROD_API_ALB_URL}/api/users/profile/update`, user, config);
...
export const listUsers = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${DJANGO_PROD_API_ALB_URL}/api/users/`, config);
...
export const deleteUser = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.delete(`${DJANGO_PROD_API_ALB_URL}/api/users/delete/${id}`, config);
...
export const updateUser = (user) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${DJANGO_PROD_API_ALB_URL}/api/users/update/${user._id}/`,
      user,
      config
    );
