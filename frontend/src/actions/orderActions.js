...
export const createOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(`${DJANGO_PROD_API_ALB_URL}/api/orders/add/`, order, config);
...
export const getOrderDetails = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${DJANGO_PROD_API_ALB_URL}/api/orders/${id}/`, config);
...
export const payOrder = (id, paymentResult) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${DJANGO_PROD_API_ALB_URL}/api/orders/${id}/pay/`,
      paymentResult,
      config
    );
...
export const listMyOrders = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${DJANGO_PROD_API_ALB_URL}/api/orders/myorders/`, config);
...
export const listOrders = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(`${DJANGO_PROD_API_ALB_URL}/api/orders/`, config);
...
export const deliverOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `${DJANGO_PROD_API_ALB_URL}/api/orders/${order._id}/deliver/`,
      {},
      config
    );
